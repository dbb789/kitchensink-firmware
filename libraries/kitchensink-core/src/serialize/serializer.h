...
struct Serializer<GlobalConfig>
{
    ...
    void deserialize(InStream& is, GlobalConfig& globalConfig);
};
...
struct Serializer<MacroSet>
{
    ...
    void deserialize(InStream& is, MacroSet& macroSet);
};
...
struct Serializer<SecureMacroSet>
{
    ...
    void deserialize(InStream& is, SecureMacroSet& macroSet);
};
...
struct Serializer<LayerStack>
{
    ...
    void deserialize(InStream& is, LayerStack& layerStack);
};
...
struct Serializer<MultiKeySet>
{
    ...
    void deserialize(InStream& is, MultiKeySet& multiKeySet);
};
...
struct Serializer<SmartKeySet>
{
    ...
    void deserialize(InStream& is, SmartKeySet& smartKeySet);
};
